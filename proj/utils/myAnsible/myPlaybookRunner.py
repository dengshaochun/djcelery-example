...
from myRunner import MyTaskQueueManager
from django.conf import settings


__all__ = ['myPlaybookRunner']
...
class CallbackModule(CallbackBase):
    ...
    def gather_result(self, res):
        if res._task.loop and 'results' in \
                res._result and res._host.name in self.item_results:
